...
#----MOVEMENT TURNING VS MOVEMENT SPEEDING----
...
propFrontTable$sessions <- factor(rep(sapply(names(windowPropFront),function(f)strsplit(f,"_")[[1]][1]),sapply(windowPropFront,length)),levels=sessions)
...
#----MOVEMENT TURNING INFLUENCE AS A FUNCTION OF TIME SPENT IN THE FRONT----
...
#----MOVEMENT SPEEDING INFLUENCE AS A FUNCTION OF TIME SPENT IN THE FRONT----
